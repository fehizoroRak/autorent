...
class CarCrudController extends AbstractCrudController
{
    ...
    public function configureActions(Actions $actions): Actions
    {
        $showCarDetail = Action::new('showCarDetail', 'Détails', 'fas fa-eye')
            ->linkToCrudAction('showAction');

        return $actions
            ->add(Crud::PAGE_INDEX, $showCarDetail)
            ->update(Crud::PAGE_INDEX, Action::EDIT,
                fn (Action $action) => $action->setIcon('fas fa-edit')->setLabel('')->addCssClass('btn btn-warning'))
            ->update(Crud::PAGE_INDEX, Action::DELETE,
                fn (Action $action) => $action->setIcon('fas fa-trash')->setLabel('')->addCssClass('btn btn-danger'));
    }
