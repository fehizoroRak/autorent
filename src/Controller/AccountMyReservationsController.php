...
class AccountMyReservationsController extends AbstractController
{
    ...
    public function index(): Response
    {
        ...
        return $this->render('account_myreservations/index.html.twig', [
            'locations' => $locations,
        ]);
    }
    ...
    public function details(int $id): Response
    {
        ...
        return $this->render('account_myreservations/details.html.twig', [
            'location' => $location,
            'status' => $status,
        ]);
    }
